...
class QTree {
 private:
  ...
  public:
    ...
    Node(const Node* & n); // own function, does not copy pointers
 ...
 public:
  ...
  /* =================== start of own public helper functions ============== */
  ...
  /* =================== end of own public helper functions ============== */
 ...
 private:
  ...
  /* =================== start of own private helpers ============== */
  
  std::priority_queue< Node*, vector<Node*>, QTree::less > nodeQueue;
  int treeSize;

  void copyRecursive(Node * & subRoot, const Node * toCopy);
  
  void clearRecursive(Node * toClear);

  // int getX(Node * t) const;
  // int getY(Node * t) const;

  void writeRecursive(Node * t, PNG & newImage);


  /* =================== end of own private helpers ============== */
